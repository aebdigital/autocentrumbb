    ...
    <div className="min-h-screen bg-white pt-36 pb-20">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-4xl">
          <p className="mb-3 font-montserrat text-sm font-semibold uppercase tracking-[0.25em] text-red-600">Autocentrumbb</p>
          <h1 className="font-jakarta text-4xl font-bold text-gray-900 md:text-5xl">Ochrana osobných údajov</h1>
          <p className="mt-6 rounded-2xl border border-red-100 bg-red-50 px-6 py-5 font-montserrat text-base leading-8 text-gray-700">
            <strong>Autocentrumbb s.r.o.</strong>
            <br />
            Zvolenská cesta 3492/141 974 05 Banská Bystrica
            <br />
            IČO: 47421410, DIČ: 2023860553 IČ DPH: SK2023860553
            <br />
            E-mail: info@autocentrumbb.sk
            <br />
            Tel.: +421 905 241 887
          </p>

          <div className="mt-8 space-y-8 font-montserrat text-gray-700">
            ...
            <section className="rounded-3xl border border-gray-200 bg-white p-7 shadow-sm">
              <h2 className="font-jakarta text-2xl font-bold text-gray-900">I. Kontaktný formulár</h2>
              <p className="mt-4 text-base leading-8">
                Na stránke www.autocentrumbb.sk prevádzkujeme kontaktný formulár na dvoch samostatných stránkach, ktorého účelom je umožniť vám:
              </p>
            ...
            <section className="rounded-3xl border border-gray-200 bg-white p-7 shadow-sm">
              <h2 className="font-jakarta text-2xl font-bold text-gray-900">II. Súbory cookies</h2>
            ...
            <section className="rounded-3xl border border-gray-200 bg-white p-7 shadow-sm">
              <h2 className="font-jakarta text-2xl font-bold text-gray-900">III. Práva dotknutej osoby</h2>
              ...
              <ul className="mt-4 list-disc space-y-2 pl-6 text-base leading-8">
                ...
                <li>
                  ...
                  <a href="https://www.dataprotection.gov.sk" target="_blank" rel="noopener noreferrer" className="font-semibold text-red-600 underline underline-offset-4">
              ...
              <p className="mt-6 text-base leading-8">
                V prípade otázok alebo uplatnenia Vašich práv nás môžete kontaktovať na info@autocentrumbb.sk alebo telefónnom čísle +421 905 241 887.
              </p>
            </section>

            <div className="rounded-2xl border border-red-100 bg-red-50 px-6 py-5 text-sm font-semibold text-red-700">
              Tieto Zásady nadobúdajú účinnosť dňom 13.5. 2025.
            </div>
          </div>
        </div>
      </div>
